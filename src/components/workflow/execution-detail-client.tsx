...
import { ExecutionStepsViewer } from "./execution-steps-viewer";
...
export function ExecutionDetailClient({ workflow, execution: initialExecution }: ExecutionDetailClientProps) {
  const [showRealTimeIndicator, setShowRealTimeIndicator] = useState(false);
  
  // Disable real-time updates for now as they're returning different data structure
  // TODO: Fix API to return consistent structure
  ...
  // Extract execution steps from result if available
  const executionSteps: ExecutionStep[] = execution.result?.steps || [];
            ...
            <div className="flex items-start justify-between mb-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  {/* Real-time indicator */}
                  {isConnected && (execution.status === "running" || execution.status === "pending") && (
                    <div className="flex items-center gap-2 mt-2">
                      <div className={cn(
                        "w-2 h-2 rounded-full transition-all",
                        showRealTimeIndicator ? "bg-green-500 scale-150" : "bg-green-500"
                      )} />
              ...
              <div className="flex items-center gap-2">
                ...
                {/* Control buttons for running executions */}
